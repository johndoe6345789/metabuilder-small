...
`,e.jsx(n.pre,{children:e.jsx(n.code,{children:`packages/\r
└── {package_name}/\r
    └── seed/\r
        ├── metadata.json      # Package info\r
        ├── components.json    # Component definitions\r
        └── scripts/\r
            └── [script-name].json  # JSON script definitions following script_schema.json\r
                                     # Must include full function implementations with bodies,\r
