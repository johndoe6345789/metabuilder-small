...
/// LogicGte implements the NodeExecutor trait for greater than or equal comparison.
pub struct LogicGte {
...
impl Default for LogicGte {
    fn default() -> Self {
        Self::new()
    }
}

impl NodeExecutor for LogicGte {
...
mod tests {
    ...
    fn test_factory() {
        let executor = create();
        assert_eq!(executor.node_type, "logic.gte");
