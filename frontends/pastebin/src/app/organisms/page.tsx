    ...
    <PageLayout>
      ...
      >
        <div style={{ marginBottom: '32px' }}>
          <h2 style={{ fontSize: '1.875rem', lineHeight: '2.25rem', fontWeight: 700, letterSpacing: '-0.025em', marginBottom: '8px' }}>Organisms</h2>
          <p style={{ color: 'var(--mat-sys-on-surface-variant)' }}>Complex UI components composed of molecules and atoms</p>
        </div>
