/**
 * Enhanced Mock DBAL Server for WorkflowUI Integration Testing
 * Simulates full DBAL API with workspaces, workflows, notifications, and user data
 * Enables greenfield workspace/workflow creation and comprehensive UI testing
 */
      ...
      nodes: [
        {
          ...
          config: { initialData: { date: new Date().toISOString() } },
          inputs: [],
          outputs: ['main'],
        },
        {
